...
--              [ CTRL+Numpad9 ]    Last Stand
--              [ CTRL+Numpad5 ]    Leaden Salute
--              [ CTRL+Numpad1 ]    Requiescat
--              [ CTRL+Numpad3 ]    Wildfire
--              [ CTRL+Numpad ]    Aeolian Edge
--              [ CTRL+Numpad ]    Evisceration
--
...
function user_setup()
    ...
    send_command('bind ^numpad9 input /ws "Last Stand" <t>')
    send_command('bind ^numpad5 input /ws "Leaden Salute" <t>')
    send_command('bind ^numpad1 input /ws "Requiescat" <t>')
    send_command('bind ^numpad3 input /ws "Wildfire" <t>')
    --send_command('bind ^numpad input /ws "Aeolian Edge" <t>')
    --send_command('bind ^numpad input /ws "Evisceration" <t>')
...
function init_gear_sets()
    ...
    ------------------------------------------------------------------------------------------------
		...
		body="Laksa. Frac +3",
		hands="Meg. Gloves +2",
		legs={ name="Herculean Trousers", augments={'Mag. Acc.+7 "Mag.Atk.Bns."+7','Weapon skill damage +4%','STR+4','Mag. Acc.+2','"Mag.Atk.Bns."+6',}},
		feet="Lanun Bottes +2",
		neck="Fotia Gorget",
	...
	sets.precast.WS['Last Stand'] = {
		...
		head={ name="Lanun Tricorne", augments={'Enhances "Winning Streak" effect',}},
		body="Laksa. Frac +3",
		hands={ name="Herculean Gloves", augments={'AGI+12','Pet: DEX+4','Weapon skill damage +9%',}},
		legs={ name="Herculean Trousers", augments={'Mag. Acc.+7 "Mag.Atk.Bns."+7','Weapon skill damage +4%','STR+4','Mag. Acc.+2','"Mag.Atk.Bns."+6',}},
		feet={ name="Lanun Bottes +2", augments={'Enhances "Wild Card" effect',}},
		neck="Fotia Gorget",
		waist="Fotia Belt",
	...
	sets.precast.WS['Wildfire'] = {
		...
		head={ name="Herculean Helm", augments={'Rng.Acc.+20 Rng.Atk.+20','Weapon skill damage +5%',}},
    ...
    sets.precast.WS['Savage Blade'] = {
		head={ name="Herculean Helm", augments={'Weapon skill damage +5%','DEX+5','Accuracy+13','Attack+14',}},
		body="Laksa. Frac +3",
		 hands={ name="Herculean Gloves", augments={'AGI+12','Pet: DEX+4','Weapon skill damage +9%',}},
		legs={ name="Herculean Trousers", augments={'Accuracy+30','Weapon skill damage +3%','STR+4',}},
		feet={ name="Lanun Bottes +2", augments={'Enhances "Wild Card" effect',}},
		neck="Caro Necklace",
		waist="Grunfeld Rope",
		left_ear="Ishvara Earring",
    ...
    sets.idle = {
		head={ name="Herculean Helm", augments={'Weapon skill damage +1%','Crit.hit rate+2','Damage taken-4%','Accuracy+18 Attack+18',}},
		body="Meg. Cuirie +2",
		hands="Meg. Gloves +2",
		legs={ name="Carmine Cuisses +1", augments={'HP+80','STR+12','INT+12',}},
		feet={ name="Lanun Bottes +2", augments={'Enhances "Wild Card" effect',}},
    ...
    sets.engaged = {
		...
		feet={ name="Herculean Boots", augments={'Accuracy+25 Attack+25','"Triple Atk."+2','STR+5','Accuracy+5','Attack+1',}},
		neck="Sanctity Necklace",
    ...
    sets.LastStandMelee = {main="Kustawi +1", sub="Blurred Knife +1", ranged="Fomalhaut"}
    sets.LastStandRanged = {main="Kustawi +1", sub="Nusku Shield", ranged="Fomalhaut"}
    sets.SavageMelee = {main="Hep. Sapara +1", sub="Blurred Knife", ranged="Ataktos"}
