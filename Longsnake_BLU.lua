...
function get_sets()
	...
	HerculeanHelm.Refesh = { name="Herculean Helm", augments={'INT+6','Spell interruption rate down -11%','"Refresh"+2','Accuracy+11 Attack+11','Mag. Acc.+11 "Mag.Atk.Bns."+11',}}
    ...
    body="Jhakri Robe +2",
    hands={ name="Herculean Gloves", augments={'Pet: Mag. Acc.+3','Mag. Acc.+21','"Refresh"+2','Accuracy+2 Attack+2',}},
    legs={ name="Carmine Cuisses +1", augments={'Accuracy+18','Attack+11','"Dual Wield"+5',}},
    feet={ name="Herculean Boots", augments={'Rng.Atk.+13','Attack+9','"Refresh"+2','Accuracy+8 Attack+8',}},
    ...
    back={ name="Rosmerta's Cape", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10','Damage taken-5%',}},
}
    ...
    feet={ name="Herculean Boots", augments={'Accuracy+15 Attack+15','"Triple Atk."+4','STR+3',}},
    neck="Mirage Stole +2",
    ...
    ammo="Mantoptera Eye",
    head={ name="Herculean Helm", augments={'Pet: DEX+2','MND+8','Weapon skill damage +7%',}},
    body="Assim. Jubbah +3",
    hands="Jhakri Cuffs +2",
    legs={ name="Luhlaza Shalwar +3", augments={'Enhances "Assimilation" effect',}},
    feet={ name="Herculean Boots", augments={'Attack+16','Weapon skill damage +5%',}},
    neck="Mirage Stole +2",
    waist="Fotia Belt",
    left_ear={ name="Moonshade Earring", augments={'Accuracy+4','TP Bonus +250',}},
    ...
    feet={ name="Amalric Nails +1", augments={'Mag. Acc.+15','"Mag.Atk.Bns."+15','"Conserve MP"+6',}},
    neck="Combatant's Torque",
    waist="Eschan Stone",
	...
	sets.JA.Diffusion = set_combine(sets.BlueMagic.Buffs, { feet = "Luhlaza Charuqs +3" })
	...
	sets.precast.FastCast.Blue = set_combine(sets.precast.FastCast.Standard, {
		body = "Hashishin Mintan +1"       --remove the -- in order to make active
	})
end
