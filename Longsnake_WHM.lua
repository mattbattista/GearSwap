...
--              [ CTRL+Numpad9 ]    Hexa Strike
--              [ CTRL+Numpad5 ]    Realmrazer
--              [ CTRL+Numpad1 ]    Flash Nova
--              [ CTRL+Numpad3 ]    Mystic Boon
--
--
...
function user_setup()
    ...
    state.BarElement = M{['description']='BarElement', 'Barfira', 'Barblizzara', 'Baraera', 'Barstonra', 'Barthundra', 'Barwatera','BarStatus', 'Baramnesra', 'Barvira', 'Barparalyzra', 'Barsilencera', 'Barpetra', 'Barpoisonra', 'Barblindra', 'Barsleepra'}
    ...
    send_command('bind ^numpad9 input /ws "Hexa Strike" <t>')
...
function init_gear_sets()
    ...
    feet={ name="Chironic Slippers", augments={'Pet: Attack+10 Pet: Rng.Atk.+10','STR+6','"Fast Cast"+7',}},
    ...
    sets.midcast['Enhancing Magic'] = {
        main="Gada",
        sub="Ammurapi Shield",
		head={ name="Telchine Cap", augments={'"Dbl.Atk."+3','Enh. Mag. eff. dur. +8',}},
		body={ name="Telchine Chas.", augments={'Enh. Mag. eff. dur. +4',}},
        hands={ name="Telchine Gloves", augments={'Enh. Mag. eff. dur. +7',}},
		legs={ name="Telchine Braconi", augments={'"Dbl.Atk."+2','Enh. Mag. eff. dur. +6',}},
        feet="Theo. Duckbills +3",
        neck="Incanter's Torque",
    ...
    sets.midcast.Regen = set_combine(sets.midcast.EnhancingDuration, {
        ...
        hands="Ebers Mitts +1",
		legs="Th. Pant. +3",
        feet={ name="Telchine Pigaches", augments={'Mag. Acc.+22','Song spellcasting time -3%','"Regen" potency+3',}},
        })
    ...
    back={ name="Alaunus's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+7','Damage taken-5%',}},
}
